...
4. **GLOW Model**: Study and application of the Generative Flow with Invertible 1x1 Convolutions (GLOW) model.
...
- **Training**: Exact maximum likelihood via change of variables formula.
...
| Concept | Description |
| :--- | :--- |
| **Normalizing Flow** | Sequence of invertible transformations mapping a simple distribution to a complex one |
| **Affine Coupling Layer** | Core RNVP building block: splits input and applies scale+translate transformations |
| **Exact Likelihood** | Unlike VAEs/GANs, flows provide exact log-likelihood computation |
| **1x1 Convolution (GLOW)** | Learnable permutation layer generalizing channel shuffling |
